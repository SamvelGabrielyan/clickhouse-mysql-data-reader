...
```mysql
CREATE USER 'reader'@'%' IDENTIFIED BY 'Q1werty.2';
CREATE USER 'reader'@'127.0.0.1' IDENTIFIED BY 'Q1werty.2';
CREATE USER 'reader'@'localhost' IDENTIFIED BY 'Q1werty.2';
...
clickhouse-client -mn < /Users/olegmahonya/Downloads/clickhouse-mysql-data-reader-master/create_clickhouse_table_template.sql
```
...
clickhouse-mysql \
    --src-host=127.0.0.1 \
    --src-user=reader \
    --src-password=Q1werty.2 \
    --migrate-table \
    --src-tables=ch_test.person \
    --dst-host=127.0.0.1
...
python3 ./main.py    --src-server-id=1     --src-resume     --src-wait     --nice-pause=1     --src-host=127.0.0.1     --src-user=reader     --src-password=Q1werty.2     --src-tables=ch_test.person     --dst-host=127.0.0.1     --csvpool     --csvpool-file-path-prefix=qwe_     --mempool-max-flush-interval=60     --mempool-max-events-num=10000     --pump-data

clickhouse-mysql     --src-server-id=1     --src-resume     --src-wait     --nice-pause=1     --src-host=127.0.0.1     --src-user=reader     --src-password=Q1werty.2     --src-tables=ch_test.person     --dst-host=127.0.0.1     --csvpool     --csvpool-file-path-prefix=qwe_     --mempool-max-flush-interval=60     --mempool-max-events-num=10000     --pump-data